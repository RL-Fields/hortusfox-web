...
return [
    ...
    array('/plants/location/{id}/notes/save', 'POST', 'plants@save_location_notes'),
    ...
    array('/api/plants/attachments/add', 'ANY', 'api@add_plant_attachment'),
    array('/api/plants/attachments/edit', 'ANY', 'api@edit_plant_attachment'),
    array('/api/plants/attachments/remove', 'ANY', 'api@remove_plant_attachment'),
    array('/api/plants/attachments/fetch', 'ANY', 'api@fetch_plant_attachments'),
